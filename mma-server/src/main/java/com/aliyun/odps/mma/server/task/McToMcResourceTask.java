...
import com.aliyun.odps.mma.server.action.McToMcResourceAction;
import com.aliyun.odps.mma.server.job.Job;

public class McToMcResourceTask extends DagTask {
  private final Job job;

  public McToMcResourceTask(String id, String rootJobId, JobConfiguration config, Job job) {
  ...
  private void init() {
    ...
    McToMcResourceAction action = new McToMcResourceAction(
            id,
            this,
            context,
            config,
