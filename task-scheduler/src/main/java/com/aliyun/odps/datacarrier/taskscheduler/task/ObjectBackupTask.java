...
public class ObjectBackupTask extends AbstractTask {
  private static final Logger LOG = LogManager.getLogger(ObjectBackupTask.class);

  private final String objectType;

  private final MetaSource.TableMetaModel tableMetaModel;

  public ObjectBackupTask(
      String id,
      String jobId,
      String objectType,
  ...
  void updateMetadata() throws MmaException {
    ...
    this.mmaMetaManager.updateStatus(
        jobId,
